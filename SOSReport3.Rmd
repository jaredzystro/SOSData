...
p<-ggplot(survey_summary, aes(x=question, y=mean)) +
  ...
  geom_text(aes(label=paste0("n = ",n), vjust=4), color="black", size=10) +
...
```{r, SeedProduction, echo=FALSE}
    renderPlot({
     ...
     BoxPlot (data = data, input = input, question = "Q26B_yes", title = "Percentage of Producers Growing Their Own Seed", xlab = paste(paste(input$state,collapse=" "),"Share of Producers"), ylab = "Percentage")
