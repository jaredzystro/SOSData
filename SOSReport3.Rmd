...
data$Q01A <- as.numeric(data$Q01A)
# Convert to years certified
data$Q01A <- 2020 - data$Q01A
# Convert to bins
data$Q01A_bin <- cut(data$Q01A, breaks=c(0,1,3,6,10,15,20,30,1000), labels=c("<1","1 - 3","4 - 6","7 - 10", "11 - 15", "16 - 20", "21 - 30", "30+"))
data$Q01A_bin <- factor(data$Q01A_bin)

### YearsCertified is the equivalent question to Q01A in 2015
...
data$Q05 <- ifelse (data$Q05 == "No answer" | data$Q05 == "partial complete" | data$Q05 == "skipped due to branching", NA, data$Q05)
# Convert from text to numeric -- 100 for veg, 0 for not. Probably a better way to do this...
data$Q05 <- ifelse (data$Q05 == "Some Annual Vegetable Crop Acres" | data$Q05 == "Some annual vegetable crop acres:", 100, 0) %>%
              as.numeric()
...
# filter to only survey data for correct states
  ...
  survey_summary$summary_labels <- paste("n = ",survey_summary$n,sep="")
...
p <- ggplot(survey_summary, aes(x=question, y=mean)) +
  ...
  ylim(0,100) +
  geom_text(aes(label=round(mean,1), vjust=2), color="black", size=10) +
 ...
 if (input$show_n) {
    p <- p + geom_text(aes(label=summary_labels, vjust=4), color="black", size=10)
  }
...
# ggplot of means (geom_bar) and error (geom_errorbar) for bins
  p <- ggplot(data = out, aes_string(x = question, y = "summary")) +
    geom_bar(stat = "identity", fill="skyblue3", color = "black", width = 0.3) +
...
#    ylim(0,100) +
  ...
  if (input$show_n) {
    p <- p + geom_text(aes(label=summary_labels, vjust=1), color="black", size=10)
  }
...
GradientMap <- function (data, input, question, title, catlab) {
...
data_sum <- filtered_data %>%
  group_by(state) %>%
    summarise(mean = mean(.data[[question]]))
...
```{r, ShowN, echo=FALSE}
checkboxInput("show_n", "Display response numbers", TRUE)
```
::::
...
```{r, Years, echo=FALSE}
    renderPlot({
       ...
       BinPlot (data = data, input = input, question = "Q01A_bin", title = "Years Certified", xlab = paste(paste(input$state,collapse = " "),"Years Certified"), ylab = "Percentage")
...
```{r, VegProducer, echo=FALSE}
    renderPlot({
       ...
       BoxPlot (data = data, input = input, question = "Q05", title = "Percentage of Respondents who Produce Vegetables", xlab = "", ylab = "Percentage")
...
```{r, VegAcre, echo=FALSE}
    renderPlot({
       ...
       BinPlot (data = data, input = input, question = "Q05_2_o_bin", title = "Vegetable Acreage", xlab = paste(paste(input$state,collapse = " "),"Vegetable Acreage"), ylab = "Percentage")
...
```{r, CoverProducer, echo=FALSE}
    renderPlot({
       ...
       BoxPlot (data = data, input = input, question = "Q05", title = "Percentage of Respondents who Produce \nCover Crops or Green Pasture", xlab = "", ylab = "Percentage")
...
```{r, CoverAcre, echo=FALSE}
    renderPlot({
       ...
       BinPlot (data = data, input = input, question = "Q05_2_o_bin", title = "Cover Crop Acreage", xlab = paste(paste(input$state,collapse = " "),"Cover Crop Acreage"), ylab = "Percentage")
...
```{r, FieldProducer, echo=FALSE}
    renderPlot({
       ...
       BoxPlot (data = data, input = input, question = "Q05", title = "Percentage of Respondents who Produce Field Crops", xlab = "", ylab = "Percentage")
...
```{r, FieldAcre, echo=FALSE}
    renderPlot({
       ...
       BinPlot (data = data, input = input, question = "Q07_2_o_bin", title = "Field Crop Acreage", xlab = paste(paste(input$state,collapse = " "),"Field Crop Acreage"), ylab = "Percentage")
...
```{r, VegOGSeed, echo=FALSE}
    renderPlot({
      ...
      BoxPlot (data = data, input = input, question = "Q05aA", title = "Percent Vegetable Acreage \nPlanted To Organic Seed", xlab = paste(paste(input$state, collapse = " "),"Vegetable Acreage"), ylab = "Percentage")
      
    }, height = PLOTHEIGHT)

renderPlot({
    
      GradientMap (data = data, input = input, question = "Q05aA", title = "Percent Vegetable Acreage \nPlanted To Organic Seed", catlab =  "Percentage")
...
```{r, CoverOGSeed, echo=FALSE}
    renderPlot({
     ...
     BoxPlot (data = data, input = input, question = "Q06aA", title = "Percent Cover Crop Acreage \nPlanted To Organic Seed", xlab = paste(paste(input$state,collapse=" "),"Cover Crop Acreage"), ylab = "Percentage")
      
}, height = PLOTHEIGHT)

renderPlot({
    
      GradientMap (data = data, input = input, question = "Q06aA", title = "Percent Cover Crop Acreage \nPlanted To Organic Seed", catlab =  "Percentage")
...
```{r, FieldOGSeed, echo=FALSE}
    renderPlot({
     ...
     BoxPlot (data = data, input = input, question = "Q07aA", title = "Percent Field Crop Acreage \nPlanted To Organic Seed", xlab = paste(paste(input$state,collapse=" "),"Field Crop Acreage"), ylab = "Percentage")
      
}, height = PLOTHEIGHT)

renderPlot({
    
      GradientMap (data = data, input = input, question = "Q06aA", title = "Percent Field Crop Acreage \nPlanted To Organic Seed", catlab =  "Percentage")
...
```{r, SeedProduction, echo=FALSE}
    renderPlot({
     ...
     BoxPlot (data = data, input = input, question = "Q26B_yes", title = "Percentage of Producers \nGrowing Their Own Seed", xlab = paste(paste(input$state,collapse=" "),"Share of Producers"), ylab = "Percentage")
      
}, height = PLOTHEIGHT)

renderPlot({
    
      GradientMap (data = data, input = input, question = "Q26B_yes", title = "Percentage of Producers \nGrowing Their Own Seed", catlab =  "Percentage")
...
```{r, NoOGSeedProcessor, echo=FALSE}
    renderPlot({
       ...
       BinPlot (data = data, input = input, question = "Q29B", title = "How much was processor (buyer) requiring \nor supplying varieties that are not available organically a factor in\n your decision NOT to purchase organic seed?", xlab = paste(paste(input$state,collapse = " "),"Factors"), ylab = "Percentage")
...
```{r, NoOGSeedSave, echo=FALSE}
    renderPlot({
       ...
       BinPlot (data = data, input = input, question = "Q29D", title = "How much was saving your own seed \na factor in your decision NOT to purchase organic seed?", xlab = paste(paste(input$state,collapse = " "),"Factors"), ylab = "Percentage")
...
```{r, NoOGSeedQual, echo=FALSE}
    renderPlot({
       ...
       BinPlot (data = data, input = input, question = "Q29E", title = "How much was distrust of organic seed quality \na factor in your decision NOT to purchase organic seed?", xlab = paste(paste(input$state,collapse = " "),"Factors"), ylab = "Percentage")
...
```{r, NoOGSeedPrice, echo=FALSE}
    renderPlot({
       ...
       BinPlot (data = data, input = input, question = "Q29F", title = "How much was price a factor in your decision \nNOT to purchase organic seed?", xlab = paste(paste(input$state,collapse = " "),"Factors"), ylab = "Percentage")
...
```{r, NoOGSeedTrait, echo=FALSE}
    renderPlot({
       ...
       BinPlot (data = data, input = input, question = "Q29H", title = "How much was the lack of desirable genetic traits \na factor in your decision NOT to purchase organic seed?", xlab = paste(paste(input$state,collapse = " "),"Factors"), ylab = "Percentage")
