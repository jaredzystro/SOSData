...
#packages <- c("survey","ggplot2","shiny","dplyr","srvyr", "sf", "spData","stringr","maps","ggiraph")
...
# Percent organic vegetable seed
...
BoxPlot <- function (input, question, title, xlab, ylab) {
  ...
  if (!is.null(data2010[[question]]) & input$Y2010) {
    ...
    graph_color <- c(graph_color, "#73853a")
  }
...
GradientMap <- function (input, question, title, catlab, year) {
  ...
  if (year == "2010") {
    ...
    p <- p + scale_fill_gradient(low = "#ffffff", high = "#73853a", na.value = "grey50", name = catlab)
    
  } else if (year == "2015") {
  
    p <- p + scale_fill_gradient(low = "#ffffff", high = "#da413d", na.value = "grey50", name = catlab) 
    
  } else if (year == "2020") {
  
    p <- p + scale_fill_gradient(low = "#ffffff", high = "#2d677f", na.value = "grey50", name = catlab)
...
```{r, CoverProducer, echo=FALSE}
    renderPlot({
       ...
       BoxPlot (input = input, question = "GrowCover", title = "Percentage of Respondents who Produce \nCover Crops or Green Pasture", xlab = "", ylab = "Percentage")
...
renderPlot({
     if (input$Y2020) {
      GradientMap (input = input, question = "OGVegiSeed", title = "2020 Percent Vegetable Acreage \nPlanted To Organic Seed", catlab =  "Percentage", year = "2020")
     }
})

renderPlot({
       if (input$Y2015) {
      GradientMap (input = input, question = "OGVegiSeed", title = "2015 Percent Vegetable Acreage \nPlanted To Organic Seed", catlab =  "Percentage", year = "2015")
     }
})

renderPlot({
       if (input$Y2010) {
      GradientMap (input = input, question = "OGVegiSeed", title = "2010 Percent Vegetable Acreage \nPlanted To Organic Seed", catlab =  "Percentage", year = "2010")
     }
})
```
...
```{r, CoverOGSeed, echo=FALSE}
    renderPlot({
     BoxPlot (input = input, question = "OGCoverSeed", title = "Percent Cover Crop Acreage \nPlanted To Organic Seed", xlab = paste(paste(input$state,collapse=" "),"Cover Crop Acreage"), ylab = "Percentage")
}, height = PLOTHEIGHT)

    renderPlot({
      if (input$Y2020) {
      GradientMap (input = input, question = "OGCoverSeed", title = "2020 Percent Cover Crop Acreage \nPlanted To Organic Seed", catlab =  "Percentage", year = "2020")
      }
    })

renderPlot({
      if (input$Y2015) {
      GradientMap (input = input, question = "OGCoverSeed", title = "2015 Percent Vegetable Acreage \nPlanted To Organic Seed", catlab =  "Percentage", year = "2015")
      }
    })
...
```{r, FieldOGSeed, echo=FALSE}
    renderPlot({
     ...
     BoxPlot (input = input, question = "OGFieldSeed", title = "Percent Field Crop Acreage \nPlanted To Organic Seed", xlab = paste(paste(input$state,collapse=" "),"Field Crop Acreage"), ylab = "Percentage")
      
}, height = PLOTHEIGHT)

    renderPlot({
      if (input$Y2020) {
        GradientMap (input = input, question = "OGFieldSeed", title = "2020 Percent Field Crop Acreage \nPlanted To Organic Seed", catlab =  "Percentage", year = "2020")
      }
    })

renderPlot({
      if (input$Y2015) {
        GradientMap (input = input, question = "OGFieldSeed", title = "2015 Percent Field Crop Acreage \nPlanted To Organic Seed", catlab =  "Percentage", year = "2015")
      }
    })

renderPlot({
      if (input$Y2010) {
        GradientMap (input = input, question = "OGFieldSeed", title = "2010 Percent Field Crop Acreage \nPlanted To Organic Seed", catlab =  "Percentage", year = "2010")
      }
    })
...
```{r, SeedProduction, echo=FALSE}
    ...
    renderPlot({
      if (input$Y2020) {
        ...
        GradientMap (input = input, question = "SeedSourceOwn0or100", title = "Percentage of 2020 Producers \nGrowing Their Own Seed", catlab =  "Percentage", year = "2020")
      ...
      if (input$Y2015) {
        ...
        GradientMap (input = input, question = "SeedSourceOwn0or100", title = "Percentage of 2015 Producers \nGrowing Their Own Seed", catlab =  "Percentage", year = "2015")
      ...
      if (input$Y2010) {
        ...
        GradientMap (input = input, question = "SeedSourceOwn0or100", title = "Percentage of 2010 Producers \nGrowing Their Own Seed", catlab =  "Percentage", year = "2010")
